...
Le tracé de Bode comprend toujours le diagramme de gain superposé avec le diagramme de phase. Dans le cas du premier ordre, la représentation directe du diagramme de Bode serait la suivante : 
\begin{center}
\includegraphics[width=.65\textwidth]{png/bode_orth}
\end{center}
